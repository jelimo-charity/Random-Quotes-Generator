let quotes = [
 ...
 function showQuote() {
    ...
    document.getElementById("displayQuotes").innerHTML = quotes[randomNumber].quote;
    document.getElementById("displayAuthor").innerHTML = quotes[randomNumber].author;
    // document.getElementById("displayProfession").innerHTML = quotes[randomNumber].profession;
    // document.getElementById("displayTopics").innerHTML = quotes[randomNumber].topics;
